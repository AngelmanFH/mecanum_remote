...
class DraggableCircleWidget(QWidget):
    ...
    def mouseMoveEvent(self, event: QMouseEvent):
        if self.dragging:
            ...
            new_center.setX(max(25 + self.circle_radius, min(new_center.x(), 175 - self.circle_radius)))
            new_center.setY(max(25 + self.circle_radius, min(new_center.y(), 175 - self.circle_radius)))
